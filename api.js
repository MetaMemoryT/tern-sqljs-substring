  ...
  Statement = (function() {
    ...
    /* Bind values to the parameters, after having reseted the statement.
    	...
    	*Warning*: ':', '@', and '$' are included in the parameters names
    	...
    	@param {(Array|Object)} values The values to bind
    ...
    /* Get one row of results of a statement.
    	...
    	@param {Array.<string>,Object} params Optional: If set, the values will be bound to the statement, and it will be executed
    ...
    /* Get one row of result as a javascript object, associating column names with
    	...
    	@param {(Array|Object)} params Optional: If set, the values will be bound to the statement, and it will be executed
    ...
    /* Shorthand for bind + step + reset
    	...
    	@param {(Array|Object)} values Value to bind to the statement
     */
